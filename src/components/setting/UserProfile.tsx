...
import { updateInformationUser } from "../../state/user/thunk.ts";
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 3 }}>
                ...
                >
                    {!(userForm.image || user?.image) && (
                        <Typography variant="h6" sx={{ color: "grey.50", fontWeight: "bold" }}>
                            {user?.firstName ? user.firstName.charAt(0).toUpperCase() : "Unknown"}
                        </Typography>
                    )}
                </Avatar>
                <Button
