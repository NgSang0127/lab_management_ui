    ...
    >
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
            <Typography variant="h5" sx={{ fontWeight: "bold", color: "primary.main" }}>
                {t('manager_asset.notification_center.title', { defaultValue: 'Notification Center' })}
            </Typography>
            <Tooltip title={t('manager_asset.notification_center.unread_tooltip', { defaultValue: 'Unread Notifications' })}>
            ...
            >
                {notifications?.length === 0 ? (
                    <Typography variant="body2" sx={{ textAlign: "center", py: 2, color: "text.secondary" }}>
                        {t('manager_asset.notification_center.no_notifications', { defaultValue: 'No notifications available' })}
                    </Typography>
                ) : (
        ...
        >
            ...
            <DialogActions>
                <Button
                    ...
                    sx={{ borderRadius: 2 }}
                >
                    {t('manager_asset.notification_center.close_button', { defaultValue: 'Close' })}
                </Button>
            </DialogActions>
        </Dialog>
    </Card>
