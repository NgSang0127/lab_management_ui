...
import {AssetSpecificResponse, fetchAssetsByUserId, Status} from '../../api/asset/assetApi.ts';
            ...
            <Box mb={4}>
                <Grid container spacing={2}>
                    ...
                    <Grid size={{xs: 12, sm: 6}} sx={{display: 'flex', justifyContent: 'flex-end', gap: 1}}>
                        <FormControl fullWidth variant="outlined" sx={{maxWidth: 450, '& .MuiOutlinedInput-root': {borderRadius: 10}}}>
                ...
                <DialogContent className="space-y-4" sx={{p: 3}} dividers>
                    {selectedAsset && (
                        <>
                            ...
                            <Typography><strong>Description:</strong> {selectedAsset.description || 'N/A'}</Typography>
                            ...
                            <Typography><strong>Category:</strong> {selectedAsset.categoryName || 'N/A'}</Typography>
                            <Typography><strong>Location:</strong> {selectedAsset.locationName || 'N/A'}</Typography>
                        </>
                    )}
                </DialogContent>
                <DialogActions>
