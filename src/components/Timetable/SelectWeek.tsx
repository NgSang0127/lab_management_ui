...
import { getFourSemesterRecent, getRangeWeek } from '../../state/Timetable/Reducer';
import { useTranslation } from 'react-i18next';
import calculateWeeks from '../../utils/calculateWeeks';
import { endOfDay, isWithinInterval, parse, startOfDay } from 'date-fns';
import { setSelectedSemesterId, setSelectedWeek } from '../../state/Timetable/Action.ts';
                ...
                >
                    {weeks.map((week, index) => (
                        <MenuItem
                            ...
                            sx={{
                                '&.Mui-selected': { backgroundColor: '#73f8e7', fontWeight: 'bold' },
                                '&:hover': { backgroundColor: '#73f8e7' },
                            }}
                        >
