...
import { getCourseLogStatistics, getDailyLogStatistic } from "../../state/dashboard/thunk.ts";
import { CourseLogStatistics, DailyLogStatistics } from "../../state/dashboard/dashboardSlice.ts";
