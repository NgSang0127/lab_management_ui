                    ...
                    {cancelDate && (
                        <>
                            {isLoading ? (
                                ...
                                <FormControl fullWidth margin="normal">
                                    <InputLabel
                                        id="timetable-select-label">{t('timetable.cancelTimetable.course')}</InputLabel>
                                    <Select
                                    ...
                                    >
                                        {timetableDate.map((timetable) => (
                                            <MenuItem key={timetable.id} value={timetable.id}>
                                                {t('timetable.cancelTimetable.menu_item', {
                                                    name: timetable.courses[0]?.name || 'NA',
                                                    room: timetable.room?.name || 'N/A',
                                                    startLesson: timetable.startLesson
                                                })}
                                            </MenuItem>
                                        ))}
                                    </Select>
