...
import { testimonials, topNews } from "../../components/home/topEvent.ts";
...
const Home: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Lab Management IT</title>
            </Helmet>
            <Box>
                {/* Introduction Section */}
                <Box py={8} sx={{ bgcolor: 'grey.50' }}>
                    <Container maxWidth="md">
                        ...
                        <Box textAlign="center" mt={4}>
                            <Button variant="contained" color="primary" size="large" href="#features"
                                    startIcon={<ScienceIcon />} onClick={() => navigate('/about-us')}>
                ...
                {/* Features Section */}
                <Box py={8} id="features-section" sx={{ bgcolor: 'background.paper' }}>
                            ...
                            <Grid size={{ xs: 12, md: 3, sm: 6 }}>
                                <FeatureCard>
                                    ...
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" color="text.secondary">
                                            {t('home.features.timetable_management_introduce')}
                                        </Typography>
                                    </CardContent>
                                </FeatureCard>
                            </Grid>
                                ...
                                <Grid size={{ xs: 12, md: 6 }} key={index}>
                                    <NewsCard>
                                        ...
                                        <Box sx={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
                                            <CardContent>
                                                <Typography component="div" variant="h6" sx={{ fontWeight: 'medium', color: 'text.primary' }}>
                                                    {news.title}
                                                </Typography>
                                                <Typography variant="body2" color="text.secondary">
                                                    {news.description}
                    ...
                    <Container maxWidth="lg">
                        ...
                        <Grid container spacing={4} mt={4} justifyContent="center">
                            {testimonials.map((testimonial, index) => (
                                <Grid size={{ xs: 12, md: 6 }} key={index}>
                                    <TestimonialCard sx={{ backgroundColor: 'grey.50' }}>
                                        <Avatar
                ...
                <FAQ />
                {/* Contact Section */}
                <Box py={8} sx={{ bgcolor: 'background.default' }} id="contact-section">
                    <Container maxWidth="lg">
                        <Typography variant="h4" align="center" gutterBottom sx={{ fontWeight: 'bold', color: 'text.primary' }}>
                        ...
                        <Grid container spacing={4} mt={4}>
                            <Grid size={{ xs: 12, md: 6 }}>
                                <Box display="flex" flexDirection="column" alignItems="center" textAlign="center">
                                    ...
                                    <Typography variant="h6" gutterBottom mt={2} sx={{ fontWeight: 'medium', color: 'text.primary' }}>
                                    ...
                                    <Typography variant="body1" color="text.secondary">
                                        Email: <Link href="mailto:info@hcmiu.edu.vn" sx={{ color: 'primary.light', textDecoration: 'underline' }} underline="hover">
                                        info@hcmiu.edu.vn
                                    </Link>
                                    </Typography>
                                </Box>
