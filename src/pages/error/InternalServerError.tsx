...
import '../../components/error/InternalServerError.css';
...
const InternalServerError = () => {
    ...
    return (
        <>
            <Helmet>
                <title>500 | Lab Management IT</title>
            </Helmet>
            <Container
                maxWidth="lg"
                sx={{
            ...
            >
                ...
                >
                    {t('error.500.title', '500 - Internal Server error')}
                </Typography>
                ...
                >
                    {t('error.500.message', 'Our servers are having a tough time. Please try again later.')}
                </Typography>
